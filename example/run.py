...
# 2. フォントを準備
font_family = [
    Font(name="en-font", path="example/fonts/avenir-next-regular.ttf"),
    Font(name="jp-font", path="example/fonts/SourceHanSansJP-Regular.ttf"),
]
...
# 4. レイアウトしたいテキスト
text_content = (
    "これはreportlab_typesettingライブラリです。"
...
# 5. テキストをレイアウト
block_width, block_height = 350, 200
